...
import 'package:c_shield_sdk_example/src/api/rasp/threat_popup_text.dart';
...
class _MockPlatform with MockPlatformInterfaceMixin implements CShieldSdkPlatform {
  ...
  @override
  Future<void> initialize({bool handleLoadAppThreat = false, bool showLoadAppThreatPopup = true, ThreatPopupText? loadAppThreatPopup}) async => _calls.add('initialize');
